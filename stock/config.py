...
def get_args():
    ...
    gp.add_argument('-i', '--input', type=str, default='./data/stock_input_final.pkl',
                    help='path to input data file.')
    gp.add_argument('-o', '--output', type=str, default='./tmp/stock_output_final',
                    help='path to output data file.')
    gp.add_argument('-ti', '--test_input', type=str, default='./data/test_100/stockonly_input_test.pkl',
                    help='path to test input data file.')
    gp.add_argument('-to', '--test_output', type=str, default='./tmp/stockonly_output_test',
                    help='path to test output data file.')
    gp.add_argument('-m', '--model', type=str, default='./tmp/stock_model_final',
